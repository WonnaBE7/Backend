...
@RestController
@RequestMapping("/api/recommendations/insurances")
@Log4j2
public class RecommendInsuranceController {
     ...
     */
    @GetMapping
    public ResponseEntity<Object> recommendInsurance(
        ...
        // JsonResponse 수정
        return JsonResponse.ok("성공적으로 추천 보험상품을 반환하였습니다.",recommendations);
    }
}
