...
@RestController
@RequestMapping("/api/user/products/savings") // URL 경로를 savings로 명확하게 변경
...
public class UserSavingsController {
    ...
    public ResponseEntity<Object> getSavingsDetail(
        ...
        return JsonResponse.ok("내 예적금 정보 조회 성공",savingsDetail);
    }
}
